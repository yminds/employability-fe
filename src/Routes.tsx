...
const LinkedInCallback = lazy(() => import("./features/authentication/LinkedinCallback.tsx"));
const GitHubCallback = lazy(() => import("./features/authentication/GithubCallback.tsx"));
...
const UserPublicProfilePage = lazy(() => import("./pages/UserPublicProfilePage.tsx"));
...
const EmployerNotFound = lazy(() => import("./components/employer/NotFound.tsx"));
...
export const routes: RouteConfig[] = [
  ...
  {
    route: "/report/:id/:id/:id/:id",
    component: <MockReportPage isSharedReport={true} />,
  },
  {
    route: "/employer/report/:id/:id/:id/:id",
    component: <MockReportPage isSharedReport={true} />,
  },
  {
...
const renderRoutes = (routesArray: RouteConfig[]) => {
  return routesArray.map((routeObj, index) => {
    if (routeObj.roles) {
      return <Route key={index} path={routeObj.route} element={routeObj.component} />;
    }
    if (routeObj.childrens) {
      return <Route key={index} path={routeObj.route} element={<Routes>{renderRoutes(routeObj.childrens)}</Routes>} />;
    }
    return <Route key={index} path={routeObj.route} element={routeObj.component} />;
  });
};
