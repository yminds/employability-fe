            ...
            <DialogContent className="p-0 max-w-2xl max-h-[100vh] overflow-y-auto minimal-scrollbar">
                ...
                <div className="flex items-center justify-center">
                    <div className="w-full inline-flex p-[42px] flex-col justify-center items-start gap-[40px]">
                        <div>
                            <h2 className="text-gray-900 text-2xl font-medium leading-8 tracking-tight">Predefined Goals</h2>
                        </div>

                        <div className="w-full">
                            <div className="flex flex-col items-start gap-3.5">
                                <label className="text-gray-900 text-base font-medium leading-5">
                                    Goal Name
                                </label>
                                <p>{goal}</p>
                            </div>
