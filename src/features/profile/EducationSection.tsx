...
//   return (
//     <div className="rounded-lg bg-white p-6 overflow-y-auto overflow-x-auto max-h-[700px] min-h-[450px]" style={{scrollbarWidth: "none"}}>
//       {/* Header */}
...
const EducationSection: React.FC<EducationSectionProps> = ({}) => {
  ...
  return (
    <div className="rounded-lg bg-white p-6 overflow-y-auto overflow-x-auto max-h-[700px] min-h-[450px]" style={{scrollbarWidth: "none"}}>
      {/* Header */}
      <div className="sticky top-0 flex justify-between items-center mb-4 bg-white py-4 z-10 shadow-sm">
        <h2 className="text-lg font-semibold text-gray-900">Education</h2>
        <div className="flex space-x-2">
          <button
            onClick={openModal}
