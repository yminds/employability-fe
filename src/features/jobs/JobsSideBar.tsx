  ...
  return (
    <div className="w-full bg-white p-[34px] pb-[32px] flex flex-col justify-start gap-6 items-stretch rounded-[9px]">
      ...
      <div className=" flex flex-col  items-stretch text-left p-4">
        <p className="text-[14px] ml-1 leading-6 font-nornmal font-['SFPro Display'] text-[#909091]">
          Goals
        </p>
        ...
        <select
          value={
            goals.length > 0
              ? goals.filter((item) => item._id == selectedGoalId)[0]._id
              : ""
          }
          className="text-black text-lg font-medium font-['Ubuntu'] leading-snug focus:outline-none "
