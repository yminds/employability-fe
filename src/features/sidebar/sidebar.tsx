...
const Sidebar: React.FC = () => {
    ...
    return (
        <aside className={`bg-white shadow-md h-screen p-8 px-4 justify-between flex-shrink-0 flex flex-col items-start gap-[40px] self-stretch overflow-y-auto overflow-x-hidden transition-all relative ${isCollapsed ? 'w-20' : 'w-64'}`}>
            ...
            <button
                ...
                className="p-2 text-gray-600 focus:outline-none self-center absolute right-[-10px]"
            >
                {isCollapsed ? '➡️' : '⬅️'}
            </button>
