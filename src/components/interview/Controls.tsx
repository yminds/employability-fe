  ...
  return (
    <div className="flex flex-col items-center justify-center h-[50%] bg-[rgba(31,209,103,0.05)] mt-2 relative">
      <div className=" max-w-[350px] flex flex-col gap-2 items-center ">
        ...
        >
          <div className="text-center text-white text-[14px] font-medium leading-tight ">
            Done Answering
          </div>
        </div>
      </div>
      <p className="text-[14px] font-normal absolute bottom-[5%] leading-[24px]">*Press 'Done Answering' to move to the next one.</p>
    </div>
  );
};
  ...
  return (
    <div className="flex gap-4 flex-row items-center py-1 px-4 w-[100%] bg-white rounded-sm ">
      ...
      {/* <div className="flex  gap-2 w-full"> */}
        <p className="text-center font-ubuntu   font-medium text[14px] text-slate-900">
        Recording...
        </p>
      {/* </div> */}
    </div>
