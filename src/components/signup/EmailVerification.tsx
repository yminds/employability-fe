  ...
  const handleVerifyClick = async () => {
    ...
    if (hasToken) {
      toast.info("An active verification code exists", {
        description:
          "Please use the existing code or click 'Resend' for a new one",
      });
    } else {
      await handleSendOtp();
      startResendTimer();
  ...
  const renderEditView = () => (
    <div className="flex flex-col items-center justify-center gap-6 p-6">
      <Button
        ...
        className="self-start m-[-35px] hover:bg-transparent"
      >
      ...
      <div className="text-center">
        ...
        <p className="text-black/60 text-body2 mb-6">
  ...
  const renderOtpView = () => (
    <div className="flex flex-col items-center justify-center gap-8 p-6 ">
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-2 text-black/60 text-body2">
          <span>
            {hasActiveToken
              ? "We've already sent an OTP to"
              : "We'll send an OTP to"}
          </span>
          <div className="flex items-center gap-1">
            <span className="text-[#09d372] w-[150px] truncate">{email}</span>
            <Button
            ...
            <>
              {slots.map((slot, idx) => (
                <div key={idx} className="w-full">
                  <div
                    className={cn(
                      "relative w-[70%] h-[60px] text-[2rem] cursor-text mx-auto",
      ...
      {isVerified ? (
        ...
        <div className="sticky top-0 z-50 w-full">
          <div className="h-[38px] bg-[#e9d4bd] flex justify-center items-center gap-[33px]">
            ...
            >
              <div className="text-black text-body2">verify now</div>
              <svg
                width="25"
                height="24"
                viewBox="0 0 25 24"
