  ...
  return (
    <>
      <div className="w-full flex items-center justify-between">
        <div className="bg-white h-[46px] rounded-lg flex items-center px-4 border border-gray-300">
          <span className="text-[#00000066] font-medium whitespace-nowrap">Goal:</span>
          {selectedGoal ? (
            <DropdownMenu onOpenChange={(open) => setDropdownOpen(open)}>
              <DropdownMenuTrigger className="flex items-center gap-1 ml-2 bg-transparent border-none outline-none cursor-pointer">
                <div className="flex items-center">
                  <span className="font-medium text-black">
                    {selectedGoal}
                  </span>
                  <span className="text-gray-600 ml-1">
                    ({experienceLevelObj[selectedGoalExperienceLevel as unknown as keyof typeof experienceLevelObj]})
                  </span>
                </div>
                <img 
