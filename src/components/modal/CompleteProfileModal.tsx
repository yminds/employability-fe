...
export default function CompleteProfileModal({
  ...
  // Memoize complex initialization
  ...
  // Memoized API hooks to prevent unnecessary recreation
  ...
  useEffect(() => {
    ...
    initializeData();
  }, [userDetails, getVerifySkills, data]);
  ...
  const handleSaveSection = useCallback(
    ...
    [validateSection, formData, isFresher, tabs, activeTab, onClose]
  );
